...
function Strategy(options, verify) {
  ...
  const query = !options.profileFields ? '' : '?fields[user]=' + options.profileFields.join(',');
  this.profileUrl = "https://api.patreon.com/api/oauth2/v2/identity" + options.profileFields
